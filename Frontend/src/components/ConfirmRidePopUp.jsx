...
const ConfirmRidePopUp = (props) => {
    ...
    return (
        <div>
            ...
            <div className='flex items-center justify-between p-3 border-2 border-yellow-400  rounded-full '>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='mt-6 w-full'>
                    <form onSubmit={(e)=>{
                        ...
                        }} type="text" className='bg-[#eee] px-6 py-2 text-lg rounded-lg w-full mt-3' placeholder='Enter OTP'/>
                        <Link to='/captain-riding' className='w-full mt-10 flex justify-center rounded-lg bg-green-600 text-white font-semibold p-3 '>Confirm</Link>

                        <button onClick={() => {
                            props.setConfirmRidePopUpPanel(false);
                        }} className='w-full mt-1 rounded-lg bg-red-600 text-white font-semibold p-3 '>Cancle</button>
                    </form>
                </div>
            </div>
        </div>
